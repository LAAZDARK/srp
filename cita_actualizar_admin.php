...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="container">
    	<form class="dato" action="guardar_cita_admin.php" method="GET" name="dato">
      ...
      <table align="center">
        ...
        <tr>
          ...
          <td><input type="date" name="dia" id="dia" min="2019-05-01" max="2020-01-01" step="1" value="<?php echo $row['dia_cita'];?>"></td>
        </tr>
        <tr>
        	<td colspan="4" align="center"><TEXTAREA rows="5" cols="30" name="motivo" value="<?php echo $row['mot_cita'];?>" placeholder="Motivo de cita, Aqui..." ></TEXTAREA><BR></td>
